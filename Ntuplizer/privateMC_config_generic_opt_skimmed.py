...
#2015 data file
options.inputFiles = [
#  '/store/himc/HINPbPbAutumn18DR/ggTauTau_TuneCP5_5p02TeV_amcatnlo_pythia8/AODSIM/NoPUlowPtPhotonReg_103X_upgrade2018_realistic_HI_LowPtPhotonReg_v2-v2/280000/0578D671-11C5-8843-88C5-67E784ACB9E0.root'
...
#  '/store/group/phys_top/gkrintir/ggTauTau_TuneCUEP_5p02TeV_MG5_aMCatNLO_pythia8-pLHE-v2/ggTauTau_TuneCUEP_5p02TeV_MG5_aMCatNLO_pythia8-AODSIM-v2/210427_160045/0000/TOP-HINppWinter16DR-00002_1.root' #2015 pp Signal no calo
#  '/store/group/phys_top/gkrintir/ggTauTau_TuneCUEP_5p02TeV_MG5_aMCatNLO_pythia8-pLHE-v3/ggTauTau_TuneCUEP_5p02TeV_MG5_aMCatNLO_pythia8-AODSIM-v3/210518_122002/0000/TOP-HINppWinter16DR-00002_1.root' #2015 pp Signal
#  '/store/himc/HINPbPbAutumn18DR/ggBBbar_5f_TuneCP5_5p02TeV_MG5_aMCatNLO_pythia8/AODSIM/NoPUlowPtPhotonReg_103X_upgrade2018_realistic_HI_LowPtPhotonReg_v2-v2/250000/076144DF-4ED6-1546-91F9-BBA1F4FF763B.root' #2018 BBbar
  '/store/himc/HINPbPbAutumn18DR/ggBBbar_5f_TuneCP5_5p02TeV_MG5_aMCatNLO_pythia8/AODSIM/NoPUlowPtPhotonReg_103X_upgrade2018_realistic_HI_LowPtPhotonReg_v2-v2/250000/07F8B913-4E42-1645-9CB7-81D7F51C0A34.root' #2018 BBbar
#  '/store/user/gkrintir/ggTauTau_TuneCP5_5p02TeV_SuperChic_pythia8/ggTauTau_TuneCP5_5p02TeV_SuperChic_pythia8_AODSIM-v1/210306_043429/0000/HIN-HINPbPbAutumn18DR-00170_1.root' #SuperChic Signal 2018
#  '/store/user/gkrintir/ggTauTau_TuneCP5_5p02TeV_amcatnlo_pythia8/ggTauTau_TuneCP5_5p02TeV_amcatnlo_pythia8_AODSIM-v1/210306_172028/0000/HIN-HINPbPbAutumn18DR-00176_1.root' #MadGraph Signal 2018
#  '/store/user/gkrintir/ggTauTau_TuneCP5_5p02TeV_HydjetDrumMB_SuperChic_pythia8/ggTauTau_TuneCP5_5p02TeV_HydjetDrumMB_SuperChic_pythia8-AODSIM-v1/210316_011627/0000/HIN-HINPbPbAutumn18DR-00186_1.root'
#  '/store/himc/HINPbPbAutumn18DR/ggBBbar_4f_TuneCP5_5p02TeV_MG5_aMCatNLO_pythia8/AODSIM/NoPUlowPtPhotonReg_103X_upgrade2018_realistic_HI_LowPtPhotonReg_v2_ext1-v2/230000/03E94DC0-FE38-4E49-9445-CA999E866E6C.root'
...
#    mvaCategoriesMap = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Spring16GeneralPurposeV1Categories"),
    ...
    #pre_packedpfcandidates = cms.InputTag('particleFlow'),
...
if config["RUNONMC"]:
  ...
  process.ntuplizer.vertices = cms.InputTag("offlinePrimaryVertices")
  process.ntuplizer.packedpfcandidates = cms.InputTag('particleFlow')
  #process.ntuplizer.pre_packedpfcandidates = cms.InputTag('particleFlow')
