...
def main():
    ...
    config.Data.outLFNDirBase = '/store/user/ajofrehe/gtau_v01'
    ...
    config.Site.whitelist=['T2_US_Purdue','T2_CH_CSCS','T2_US_Wisconsin', 'T2_CH_CERN','T2_US_MIT', 'T2_US_Florida', 'T2_US_UCSD', 'T2_IT_Bari']
